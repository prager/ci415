<div class="modal fade" id="tech" tabindex="-1" aria-labelledby="techLabel" aria-hidden="true">
    <div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">About MDARC Membership Portal</h5>
